...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-24 md:py-40 relative reveal">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 md:mb-24 gap-8 md:gap-10">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tighter drop-shadow-2xl">
              Curated Services
            </h2>
          </div>
          
          {/* Custom Toggle - Liquid Glass Pill */}
          <div className="mac-glass p-1.5 rounded-full inline-flex relative bg-black/40 border border-white/10 w-full sm:w-auto">
            {/* Sliding Background */}
            <div 
            ...
            <button
              ...
              className={`relative z-10 flex-1 sm:flex-none px-6 md:px-10 py-3 md:py-4 rounded-full text-sm font-bold transition-colors duration-500 ${
